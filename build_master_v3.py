#!/usr/bin/env python3
"""Compile NotebookLM_Master_Codebase_V3.txt — a single-file audit bundle.
...
OUT = ROOT / "NotebookLM_Master_Codebase_V3.txt"
...
def main() -> int:
    parts: list = []
    parts.append(
        "NOTEBOOKLM MASTER CODEBASE — V3 (FINAL AUDIT BUNDLE)\n"
